...
static constexpr Bitboard RookMagicNumbers[64] = {
    ...
    0x200046000122ULL,     0x480040080024001ULL,  0x2040004010002000ULL,
    0x104044020020010ULL,  0x208008010100ULL,     0x2008020400040800ULL,
    0x2008020004008080ULL, 0x10010004040080ULL,   0x4020410820004ULL,
    0x200040100a0ULL,      0x3000600002200100ULL, 0x420200201001100ULL,
    0x100080600080100ULL,  0x480040080800800ULL,  0x2060080040200ULL,
    0x8020401004040200ULL, 0x201040200ULL,        0x101004102004081ULL,
    0x4001008400a20001ULL, 0x2000100084120ULL,    0x8000400082002101ULL,
    0x1000200040100042ULL, 0x2000040800100244ULL, 0x800000444810a01ULL,
    0x100880082000401ULL,
};
...
static constexpr Bitboard BishopMagicNumbers[64] = {
    ...
    0x810102c808880400ULL, 0xe900410884800ULL,    0x2002c5080020ULL,
    0x8040303010a100ULL,   0x2003084000804001ULL, 0x100140080800800ULL,
    0x2a80081012800ULL,    0x400200100200ULL,     0x1010000104016200ULL,
    0x800040800100225ULL,  0x400101002004108ULL,  0x2282020020ULL,
    0x8280140408010800ULL, 0x2082a0010400ULL,     0x14000440108800ULL,
    0x8b04000a000c0200ULL, 0x6002002004100840ULL, 0x4000202040402ULL,
    0x604004401002110ULL,  0x2010a04018010ULL,    0x4100120400800ULL,
    0x12020402020300ULL,   0x1080040000200ULL,    0x40441100201020ULL,
    0x8020008000810100ULL, 0x2001a0080401800ULL,  0x200024040200ULL,
    0x4040800800100ULL,    0x400a000400ULL,       0x8042020200ULL,
    0x2110100200100ULL,    0x1240804000ULL,       0x8000202040104ULL,
    0x44000810400100ULL,   0x20010414200040ULL,   0x20048008000ULL,
    0x2000404040201ULL,    0x1101010040200ULL,    0x2010200080100ULL,
    0x4080808040000ULL,    0x2000440041002200ULL, 0x200c005000ULL,
    0x41000a2000084ULL,
};
...
static void init_magics(Magic* magics, Bitboard* table,
                         const Bitboard* magic_numbers, bool is_bishop) {
